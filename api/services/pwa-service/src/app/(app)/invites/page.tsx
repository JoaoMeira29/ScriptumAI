...
function Badge({
  ...
  const classes: Record<string, string> = {
    primary:
      "bg-primary text-primary-foreground text-xs font-medium px-2.5 py-0.5 rounded-full",
    muted:
      "bg-muted text-muted-foreground text-xs font-medium px-2.5 py-0.5 rounded-full",
    success:
      "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 text-xs font-medium px-2.5 py-0.5 rounded-full",
    error:
...
export default function InvitesPage() {
  ...
  const fetchInvites = async () => {
    ...
    try {
      ...
      const invitesList = Array.isArray(list) ? list : [];
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Manage user invites for the organization
            </p>
          </div>
