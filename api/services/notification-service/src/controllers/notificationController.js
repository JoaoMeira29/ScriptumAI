...
class NotificationController {
  ...
  async sendNotification(req, res) {
    try {
      // For regular users, userId comes from JWT.
      // For service tokens, allow providing target userId in the body.
      ...
      const userId = userRole === 'service' ? (bodyUserId || null) : jwtUserId;
